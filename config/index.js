export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx67924c49b701df85",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8ccfc814f9b11ee29511326ec5fc58c9",
  ...
  // 每日一言的内容类型
  // 可以填写【动画，漫画，游戏，小说，原创，网络，其他】； 随机则填写 "动漫"
  LITERARY_PREFERENCE: "",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "嘉荣哥哥", "year": "2000", "date": "09-08"},
        {"type": "节日", "name": "和哥哥在一起已经", "year": "2022", "date": "08-06"},
